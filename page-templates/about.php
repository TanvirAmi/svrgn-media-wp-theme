 ...
 * page slug being "about". All 5 sections below are widget areas — add
 * the matching SVRGN: About * widget to each from Appearance > Widgets
 * to edit content; leave any area empty and the original design copy
 * shows automatically (see svrgn_section() in inc/template-tags.php).
 *
 * Widget areas used here: about-hero, about-story, about-team,
 * about-values, about-cta.
 */
get_header();
?>
