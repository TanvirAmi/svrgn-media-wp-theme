<?php
/**
 * Template for the page with slug "contact".
 * All copy sections are widget areas. The form itself stays coded
 * (functional submit via inc/contact-form.php) since it collects data
 * rather than displaying content — everything around it is editable.
 */
get_header();
?>
